    ...
    <div class="regist">
        <div class="regist_center">
            <div class="regist_top">
                ...
                <div class="right fr"><a href="../index.jsp" target="_self">二货商城</a></div>
                <div class="clear"></div>
            ...
            <div class="regist_main center">
                ...
                <div class="username">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;校:&nbsp;&nbsp;<input class="shurukuang" type="text" id="college" name="college" placeholder="请填写所在院校"/><span>快去寻找同校小伙伴！</span></div>
                <div class="username">
